...
const SecondTab = (params) => {
  ...
  function realizar_intercambio(
    ...
    const url =
      "http://localhost:8000/game_phases/trade_with_bank?lobby_id=" +
      params.jugador_datos.codigo_partida +
      "&resource_type=" +
      recurso_ofrecido +
      "&amount=" +
      cantidad_ofrecida +
    ...
    <div className="SecondTab_partida">
      ...
      >
        <div
          style={{
            ...
            border: global_info.realizando_intercambio
              ? "3px solid " +
                (global_info.recurso_ofrecido == "WOOD" ? "green" : "white")
              : "1px solid white",
        ...
        <div
          style={{
            border: global_info.realizando_intercambio
              ? "3px solid " +
                (global_info.recurso_ofrecido == "CLAY" ? "green" : "white")
              : "1px solid white",
            width: "40%", // Establecer el ancho del cuadrado
            height: "50px", // Establecer la altura del cuadrado
            display: "flex", // Establecer la propiedad display a "flex"
      ...
      >
        <div
          style={{
            border: global_info.realizando_intercambio
              ? "3px solid " +
                (global_info.recurso_ofrecido == "SHEEP" ? "green" : "white")
              : "1px solid white",
            width: "40%", // Establecer el ancho del cuadrado
            height: "50px", // Establecer la altura del cuadrado
            display: "flex", // Establecer la propiedad display a "flex"
        ...
        <div
          style={{
            border: global_info.realizando_intercambio
              ? "3px solid " +
                (global_info.recurso_ofrecido == "WHEAT" ? "green" : "white")
              : "1px solid white",
            width: "40%", // Establecer el ancho del cuadrado
            height: "50px", // Establecer la altura del cuadrado
            display: "flex", // Establecer la propiedad display a "flex"
      ...
      <div
        style={{
          border: global_info.realizando_intercambio
            ? "3px solid " +
              (global_info.recurso_ofrecido == "STONE" ? "green" : "white")
            : "1px solid white",
          width: "40%", // Establecer el ancho del cuadrado
          height: "50px", // Establecer la altura del cuadrado
          display: "flex", // Establecer la propiedad display a "flex"
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            {params.jugador_datos == null
              ? 0
              : params.jugador_datos.used_knights}
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            {params.jugador_datos == null
              ? 0
              : params.jugador_datos.victory_points}
          </div>
        </div>
      </div>
    </div>
