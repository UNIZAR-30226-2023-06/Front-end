...
export default function Amigos_Todos() {
            ...
            for (let i = 0; i < data.number_of_friends; i++) {
              const imagen =
                data.friends[i].profile_picture === "default"
                  ? `${process.env.REACT_APP_URL_FRONTED}/fotos_perfil/skin1.png`
                  : `${process.env.REACT_APP_URL_FRONTED}/fotos_perfil/skin${data.friends[i].profile_picture}.png`;
  ...
  return (
    ...
    <div className="w-full h-full flex imagenCustomPrivateHome">
      ...
      <div>
        <h1 className="m-14">
          <div className="bg-cyan-900/60 rounded-lg p-4 inline-flex flex-col items-center h-4/5 "style={{minHeight: "640px", minWidth: "1290px"}}>
